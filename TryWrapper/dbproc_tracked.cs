...
namespace GeneratedTracked
{
	public class DbProc
	{
		...
		public DbProc (NpgsqlConnection Conn, IDbProcTracker<TryWrapper.SampleTracker.Call> Tracker, Func<byte[], byte[]> Encryptor, Func<byte[], byte[]> Decryptor)
		{
			this.Conn = Conn;
	...
	public class alexey
	{
		...
		public async Task<get_aggregates_Result> get_aggregatesAsync (float? coef)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_aggregates"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "result", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "result", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "ag_sum", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "ag_sum", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "ag_avg", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "ag_avg", ResCmd, Set.Count);
		...
		public async Task<get_array_Result> get_arrayAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_array"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "names", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "names", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "by_person", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "by_person", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "grouping_sets", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "grouping_sets", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "rollup", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "rollup", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "cube", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "cube", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "unnest", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "unnest", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "unnest_alias_cols", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "unnest_alias_cols", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "generate_series", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "generate_series", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "second", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "second", ResCmd, Set.Count);
		...
		public async Task<get_composite_Result> get_compositeAsync (TryWrapper.Town destination)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_composite"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "matched", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "matched", ResCmd, Rows);
		...
		public async Task<List<get_db_qualified_Result_own>> get_db_qualifiedAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_db_qualified"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "own", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "own", ResCmd, Set.Count);
		...
		public async Task<get_dml_cte_columns_Result> get_dml_cte_columnsAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_dml_cte_columns"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "deleted_rows", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "deleted_rows", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "deleted_agg", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "deleted_agg", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "inserted_rows", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "inserted_rows", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "updated_rows", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "updated_rows", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "joined_rows", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "joined_rows", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "no_returning", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "no_returning", ResCmd, Set.Count);
		...
		public async Task<List<get_inserted_Result_inserted>> get_insertedAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_inserted"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "inserted", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "inserted", ResCmd, Set.Count);
		...
		public async Task<List<get_join_single_Result_joined>> get_join_singleAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_join_single"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "joined", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "joined", ResCmd, Set.Count);
		...
		public async Task<get_named_argument_calls_Result_result> get_named_argument_callsAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_named_argument_calls"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "result", ResCmd, Rows);
		...
		public async Task<get_numeric_types_math_Result_result> get_numeric_types_mathAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_numeric_types_math"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		public async Task<get_operators_Result_result> get_operatorsAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_operators"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		public async Task<get_returning_Result> get_returningAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_returning"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "insert_result_1", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "insert_result_1", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "insert_result_2", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "insert_result_2", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "delete_result_1", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "delete_result_1", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "update_result_1", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "update_result_1", ResCmd, Set.Count);
		...
		public async Task<get_single_row_Result_partial> get_single_rowAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_single_row"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		public async Task<get_user_and_details_Result> get_user_and_detailsAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_user_and_details"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "user", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "user", ResCmd, Rows);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "details", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "details", ResCmd, Set.Count);
		...
		public async Task<get_value_types_Result> get_value_typesAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_value_types"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "expressions_2", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "expressions_2", ResCmd, Rows);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "nulls", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "nulls", ResCmd, Rows);
		...
		public async Task<get_variadic_calls_Result_result> get_variadic_callsAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "get_variadic_calls"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		public async Task<getdeptchain_Result_res01> getdeptchainAsync (int? p_id)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "getdeptchain"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "res01", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "res01", ResCmd, Rows);
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "insert_conflict"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
		...
		public async Task<persons_getall_Result> persons_getallAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "persons_getall"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "users", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "users", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "ownership", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "ownership", ResCmd, Set.Count);
			...
			)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "roomsforperson"))
			{
				try
				{
					using (var Tran = DbProc.BeginTransactionOptionalAsync ().Result)
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "res01", ResCmd, Set.Count);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "res02", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "res02", ResCmd, Set.Count);
		...
		public async Task<List<test_distinct_on_several_Result_sample>> test_distinct_on_severalAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_distinct_on_several"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "sample", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "sample", ResCmd, Set.Count);
		...
		public async Task<test_duplicate_open_Result> test_duplicate_openAsync (int? i)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_duplicate_open"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "scalar", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "scalar", ResCmd, Rows);
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "single", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "single", ResCmd, Rows);
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_exception"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
		...
		public async Task<List<test_from_select_Result_result>> test_from_selectAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_from_select"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_get_diagnostics"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
		...
		public async Task<int?> test_jsonAsync (string data, string data_b)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_json"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "sample", ResCmd, Rows);
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_loops"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
			...
			)
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_out"))
			{
				try
				{
					using (var Tran = DbProc.BeginTransactionOptionalAsync ().Result)
					{
						using (var Cmd = Conn.CreateCommand ())
						{
							...
							using (var ResCmd = Conn.CreateCommand ())
							{
								...
								DbProc.Tracker.OnBeforeFetchCursor (Tracking, "result_1", ResCmd);
								...
								DbProc.Tracker.OnAfterFetchCursor (Tracking, "result_1", ResCmd, Rows);
		...
		public async Task<test_read_encrypted_Result_sample> test_read_encryptedAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_read_encrypted"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		public async Task<List<test_temp_table_Result_sample>> test_temp_tableAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_temp_table"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		public async Task<List<Guid?>> test_unresolved_function_unusedAsync ()
		{
			...
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_unresolved_function_unused"))
			{
				try
				{
					using (var Tran = await DbProc.BeginTransactionOptionalAsync ())
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("alexey", "test_write_encrypted"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
	...
	public class ext
	{
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("ext", "calc"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
		...
		{
			using (var Tracking = DbProc.Tracker.OnEnter ("ext", "empty"))
			{
				try
				{
					using (var Cmd = Conn.CreateCommand ())
